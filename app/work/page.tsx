...
export default function WorkPage() {
  return (
    <>
            ...
            <div className="mb-8">
              ...
              <div className="grid md:grid-cols-2 gap-4">
                {[
                  ...
                  "Google Workspace for Nonprofits implementation for team communication and collaboration",
                  "Ongoing strategic guidance and fractional COO support",
                ].map((item, i) => (
        ...
        <div className="container-width">
          <div className="max-w-4xl mx-auto">
            <div className="mb-8">
              ...
              <h2 className="text-4xl font-bold text-navy mb-4">Soulivity Media</h2>
              <p className="text-xl text-gray-600 leading-relaxed">
      ...
      <section className="bg-teal bg-opacity-90 py-10">
        <div className="container-width">
          <div className="max-w-4xl mx-auto">
            ...
            <h2 className="text-3xl font-bold text-navy mb-3">Digital Infrastructure Work</h2>
            <p className="text-white text-lg leading-relaxed">
      ...
      {/* Case Study 04 — Building Better Men */}
      <section className="section-padding bg-gray-100">
        <div className="container-width">
          <div className="max-w-4xl mx-auto">
            <div className="mb-8">
